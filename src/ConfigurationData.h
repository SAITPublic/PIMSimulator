...
const static ConfigurationData defaultConfiguration[] = {
    ...
    DEFINE_UINT_CONFIG(NUM_SUBARRAYS, DEV_PARAM),
    DEFINE_UINT_CONFIG(NUM_S_BLOCKS, DEV_PARAM),
    ...
    DEFINE_UINT_CONFIG(tCWL, DEV_PARAM),
